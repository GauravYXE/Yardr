		...
		return (
			<ScrollView style={styles.container}>
				<ThemedView style={styles.content}>
					...
					{/* Create Garage Sale Button - PROMINENT */}
					<TouchableOpacity
						style={styles.createSaleButton}
						onPress={() => router.push("/add-sale")}
					>
						<View style={styles.createSaleIconContainer}>
							<Text style={styles.createSaleIcon}>➕</Text>
						</View>
						<View style={styles.createSaleTextContainer}>
							<Text style={styles.createSaleTitle}>Create Garage Sale</Text>
							<Text style={styles.createSaleSubtitle}>
								Post your items and reach local buyers
							</Text>
						</View>
						<Text style={styles.createSaleArrow}>›</Text>
					</TouchableOpacity>
					...
					<View style={styles.guestCard}>
						...
						<View style={styles.featureList}>
							...
							<View style={styles.featureItem}>
								<ThemedText style={styles.featureIcon}>☁️</ThemedText>
								<ThemedText style={styles.featureText}>
									Sync your sales across all devices
								</ThemedText>
							</View>
						</View>
...
const styles = StyleSheet.create({
	...
	// Create Garage Sale Button - PROMINENT STYLING
	createSaleButton: {
		flexDirection: "row",
		alignItems: "center",
