...
export default function TestVideoScreen() {
    ...
    return (
      <View style={styles.container}>
        <ThemedView style={styles.content}>
          ...
          <ThemedText style={styles.subtitle}>This may take a few seconds</ThemedText>

          <View style={styles.stepsContainer}>
            <ThemedText style={styles.step}>✓ Video recorded</ThemedText>
            <ThemedText style={styles.step}>⏳ Extracting frames...</ThemedText>
            <ThemedText style={styles.step}>⏳ Calling Claude API...</ThemedText>
            <ThemedText style={styles.step}>⏳ Uploading to Supabase...</ThemedText>
          </View>
        </ThemedView>
      </View>
    );
  ...
  return (
    <View style={styles.container}>
      ...
      <ThemedView style={styles.content}>
        <ThemedText style={styles.sectionTitle}>📹 Video Feature Test</ThemedText>
        <ThemedText style={styles.description}>
          This will test the complete video workflow:
        </ThemedText>

        <View style={styles.stepsContainer}>
          <ThemedText style={styles.step}>1️⃣ Record a 5-second video</ThemedText>
          <ThemedText style={styles.step}>2️⃣ Extract frames from video</ThemedText>
          <ThemedText style={styles.step}>3️⃣ Analyze with Claude AI</ThemedText>
          <ThemedText style={styles.step}>4️⃣ Upload to Supabase Storage</ThemedText>
        ...
        {result && (
          <View style={styles.resultContainer}>
            ...
            <ThemedText style={styles.resultText}>
              <ThemedText style={styles.bold}>Description:</ThemedText> {result.description}
            </ThemedText>
            <ThemedText style={styles.resultText}>
              <ThemedText style={styles.bold}>Categories:</ThemedText> {result.categories.join(', ')}
            </ThemedText>
            <ThemedText style={styles.resultText}>
              <ThemedText style={styles.bold}>Video URL:</ThemedText> {result.videoUrl}
            </ThemedText>
          </View>
        )}
        ...
        <View style={styles.requirementsContainer}>
          ...
          <ThemedText style={styles.requirement}>✓ Run SQL migration (add video_url column)</ThemedText>
          <ThemedText style={styles.requirement}>✓ Create 'garage-sale-videos' storage bucket (public)</ThemedText>
          <ThemedText style={styles.requirement}>✓ Test on real device (camera required)</ThemedText>
          <ThemedText style={styles.requirement}>✓ Claude API key configured</ThemedText>
        </View>
      </ThemedView>
    </View>
  );
